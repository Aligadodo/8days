...
const pack:LifePack={day:1,outside:[
 n("apartment-cuttings","公寓右花坛的修剪余叶","gather",[[455,286],[495,287],[533,303],[529,324],[477,323],[454,309]],[492,306],[514,389],341,"公寓门右侧真实低花坛，街坊把修剪余叶留在外缘供人整理。只收一小份自然落叶和细纤维，不攀围栏、不折活枝。","这一轮余叶已收好；让花坛休息一会儿，等下一次街坊整理。","cloth"),
 ...
 n("postcard-cuttings","明信片桌的共享修剪叶","gather",[[244,586],[268,581],[289,600],[287,630],[263,642],[241,627]],[264,616],[362,620],721,"明信片桌右端真实小盆栽，店主将少量修剪草叶留给读者作书签材料。从桌右上侧地砖取一份，不拿走花盆或整株植物。","这一轮书签草叶已整理好，等店主下次修剪再来。","herbs"),
...
const supports: Record<string, Pick<LifeNode["visual"], "mount" | "support">> = {
  "d01-life-apartment-cuttings": { mount: "ground", support: "公寓门右侧围栏前的低花坛外缘，角色站在花坛东南人行道。" },
  "d01-life-postcard-cuttings": { mount: "table", support: "明信片桌右端真实盆栽，盆底由桌面支撑，从桌右上侧取少量修剪叶。" },
