...
const pack:LifePack={
  day:8,
  outside:[
    {id:"d08-life-east-rock-samples",title:"东岸石路的松散石屑",kind:"gather",position:p(1455,591),approach:p(1496,628),
      baked:shape([[1437,582],[1453,573],[1468,581],[1474,592],[1463,603],[1442,601]]),
      visual:{mount:"ground",layer:"ground",support:"东岸近紫晶岩台的宽石路上原生松散小石，站在内侧岩面拣取，不下水也不撬晶体基座",depth:p(0,603).y},
      description:"来到东岸后，从宽石路上拣一小份已经松散的普通石屑作对照样本。它们不是母晶或桥基；完整路基和发光晶簇都留下，等后续巡检整理下一份。",
      emptyText:"这一处松散石屑已经收过，完整岩路与晶体仍保留。稍后再来检查新的零散样本。",lootTable:"stone",renewSeconds:420},
  ...
  inside:[
    ...
    {id:"d08-life-right-tin",title:"桌下右罐的公共矿样",kind:"gather",position:p(323,412),approach:p(341,489),baked:shape([[301,393],[325,385],[341,393],[344,411],[313,420],[302,411]]),visual:{mount:"table",support:"左工作台下层搁板中间独立圆罐，与左罐分开命中，从桌前取样后盖好",depth:p(0,431).y},description:"右圆罐存放实验站定期补充的公共散矿样，每轮领取一小份。开盖分取，随后盖回防潮；整罐与正式标本留给实验站，等下一轮分样。",emptyText:"右罐这轮分样已经领取，等待实验站补充分样，不取走整罐。",lootTable:"mineral",renewSeconds:420},
