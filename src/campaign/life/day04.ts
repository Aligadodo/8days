...
const pack:LifePack={day:4,
  outside:[
    ...
    node("step-seam","下游石阶接缝里的松散石屑","gather",[[532,711],[545,702],[557,709],[552,723],[537,728]],
      [525,699],728,"下游阶梯转角的独立石块接缝，从阶面观察，不与虹台湿苔发现重叠。",
      "小块碎屑积在石阶接缝，说明这里常有水流过。反复确认落脚处，只拣已经松散的一小份石屑，不撬动阶石或扩大缝隙；等水雾慢慢积下新的细屑再来。","stone"),
  ...
  inside:[
    ...
    node("partition-pot","隔墙盆栽的养护落叶","gather",[[739,296],[760,281],[783,290],[798,313],[791,349],[769,365],[747,351]],
      [715,391],365,"标本桌东侧、石隔墙西侧的原生盆栽，从前方暖色地砖观察。",
      "盆沿接住了窗边飘来的细水雾。检查叶面与盆底，再按观测所的养护约定整理一份自然落叶纤维；不摘活叶、不挪走挡在墙边的盆栽，下一轮养护后再来。","cloth"),
  ],
};
export default pack;
